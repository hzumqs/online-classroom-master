...
import com.service_wechat.service.MessageService;
...
public class MessageServiceImpl implements MessageService {
    ...
    public void pushPayMessage(long orderId) {
        String openid = "oRSDa503d961dofRGYThuebExjTw";
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser(openid)//要推送的用户openid
                .templateId("dmH5e7QQ8lzW3G65jngTk5mKpVTKDsyTARffI_5RZZo")//模板id
                .url("http://45nj779995.zicp.fun/#/pay/"+orderId)//点击模板消息要访问的网址
                .build();
